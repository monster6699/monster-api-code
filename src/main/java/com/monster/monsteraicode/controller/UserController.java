...
import com.monster.monsteraicode.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        String userAccout = userRegisterRequest.getUserAccount();
    ...
    @GetMapping("/get")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    @Operation(summary =  "根据用户id获取用（仅管理员）")
     ...
     */
    @GetMapping("/get/vo")
    @Operation(summary =  "根据用户id获取用（脱敏数据）")
